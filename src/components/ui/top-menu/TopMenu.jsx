...
export default function TopMenu() {
  ...
  return (
    <div className='fixed top-0 right-0 w-full z-10' style={{ backdropFilter: 'blur(15px)' }}>
      ...
      <div className='flex flex-col md:flex-row md:items-center md:justify-between sm:px-9 text-white'>
        <div className='flex flex-wrap justify-center py-2'>
          <img src="/v-color.svg" className='hidden sm:block sm:mr-1' alt="" width={30} />
          <h5 className={classNames('text-nowrap sm:mx-2 antialiased font-medium cursor-pointer', { 'text-dark': mode, 'text-light': !mode })}>Sobre mi</h5>
          <h5 className={classNames('mx-1 sm:mx-2 antialiased font-medium cursor-pointer', { 'text-dark': mode, 'text-light': !mode })}>Proyectos</h5>
          <h5 className={classNames('mx-1 sm:mx-2 antialiased font-medium cursor-pointer', { 'text-dark': mode, 'text-light': !mode })}>Certificaciones</h5>
