    ...
    <div className='fixed top-0 right-0 w-full z-20 blur-backdrop' >
      ...
      <div className='flex flex-col-reverse md:flex-row md:items-center md:justify-between sm:px-9 text-white'>
        <div className='flex mx-auto md:m-0 py-2'>
          ...
          <h5 onClick={scroll} id='sobremi' className={classNames('hidden md:flex text-nowrap sm:mx-2 antialiased font-medium cursor-pointer', { 'text-dark': mode, 'text-light': !mode })}>
            Sobre mi
          </h5>
          ...
          <h5  onClick={scroll} id='contacto'className={classNames('mx-1 sm:mx-2 antialiased font-medium cursor-pointer', { 'text-dark': mode, 'text-light': !mode })}>Contacto</h5>
        </div>
